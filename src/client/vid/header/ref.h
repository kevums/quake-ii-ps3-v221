...
typedef struct
{
	...
	void	(EXPORT *DrawGlyphStringScaled)(int x, int y, const char *text,
		int count, float scale, int xor_mask);
...
void Draw_GlyphStringScaled(int x, int y, const char *text, int count,
