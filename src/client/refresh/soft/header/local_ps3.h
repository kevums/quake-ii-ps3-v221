...
extern pixel_t *stereo_left_frame;
extern int swap_current;
extern int ps3_stereo_eye;
...
void PS3SPU_Init(void);
void PS3SPU_Shutdown(void);
qboolean PS3SPU_ConvertFrame(const pixel_t *source, uint32_t source_width,
