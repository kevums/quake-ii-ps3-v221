...
CL_RequestNextDownload(void)
{
	...
	PS3_BOOT_TRACE("CL_RequestNextDownload: before client CM_LoadMap");
	CM_LoadMap(cl.configstrings[CS_MODELS + 1], true, &map_checksum);
	PS3_BOOT_TRACE("CL_RequestNextDownload: client CM_LoadMap complete");
	...
	PS3_BOOT_TRACE("CL_RequestNextDownload: before sound registration");
	CL_RegisterSounds();
	PS3_BOOT_TRACE("CL_RequestNextDownload: before CL_PrepRefresh");
	CL_PrepRefresh();
	PS3_BOOT_TRACE("CL_RequestNextDownload: CL_PrepRefresh complete");
