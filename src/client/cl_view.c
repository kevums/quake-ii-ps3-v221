...
CL_PrepRefresh(void)
{
	...
	PS3_BOOT_TRACE("CL_PrepRefresh: entered");
	...
	SCR_UpdateScreen();
	PS3_BOOT_TRACE("CL_PrepRefresh: before world registration");
	R_BeginRegistration (mapname);
	PS3_BOOT_TRACE("CL_PrepRefresh: world registration complete");
	Com_Printf("                                     \r");
	...
	PS3_BOOT_TRACE("CL_PrepRefresh: temporary models complete");
	...
	PS3_BOOT_TRACE("CL_PrepRefresh: models complete");
	...
	PS3_BOOT_TRACE("CL_PrepRefresh: images complete");
	...
	R_EndRegistration();
	PS3_BOOT_TRACE("CL_PrepRefresh: renderer registration ended");
	...
	OGG_PlayTrack(track);
	PS3_BOOT_TRACE("CL_PrepRefresh: complete");
}
