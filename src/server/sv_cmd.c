...
SV_GameMap_f(void)
{
	...
	PS3_BOOT_TRACE("SV_GameMap_f: entered");
	...
	PS3_BOOT_TRACE("SV_GameMap_f: before SV_Map");
	SV_Map(false, map, false, false);
	PS3_BOOT_TRACE("SV_GameMap_f: SV_Map complete");

	/* archive server state */
	Q_strlcpy(svs.mapcmd, map, sizeof(svs.mapcmd));
	PS3_BOOT_TRACE("SV_GameMap_f: map command archived");

	/* copy off the level to the autosave slot */
	if (!dedicated->value)
	{
		PS3_BOOT_TRACE("SV_GameMap_f: before autosave state write");
		SV_WriteServerFile(true);
		PS3_BOOT_TRACE("SV_GameMap_f: before save0 copy");
		SV_CopySaveGame("current", "save0");
		PS3_BOOT_TRACE("SV_GameMap_f: save0 copy complete");
	}
}
...
SV_Map_f(void)
{
	...
	PS3_BOOT_TRACE("SV_Map_f: entered");
	...
	SV_WipeSavegame("current");
	PS3_BOOT_TRACE("SV_Map_f: savegame cleared");
	SV_GameMap_f();
	PS3_BOOT_TRACE("SV_Map_f: complete");
}
